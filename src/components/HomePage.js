        ...
        <div className="max-h-screen">
            <div className="relative px-6 lg:px-8 md:px-3 sm:px-2 max-h-screen">
                <div className="mx-auto max-w-3xl pt-2  sm:pt-36 max-h-screen">
                    <div className="sm:mb-8 sm:flex sm:justify-center max-h-screen">
                        <div>
                            ...
                            <div className="mt-5 flex gap-x-4 sm:justify-center relative  max-h-screen">
                                <img src={soup} alt="foodImage" className="w-8/12  max-h-screen"></img>
                                <Link to={'/sign-up'} className="animate-bounce absolute top-0 drop-shadow-lg px-8 inline-block rounded-lg bg-green-800 px-4 py-1.5 text-base font-semibold leading-7 text-white shadow-sm ring-1 ring-green-700 hover:bg-green-900 hover:ring-green-800 w-1/3 text-center  max-h-screen">
